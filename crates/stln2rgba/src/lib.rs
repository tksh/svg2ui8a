...
// Simple RGBA result returned from stln2rgba.
...
/// Options for stln2rgba rasterization.
#[wasm_bindgen(getter_with_clone)]
pub struct Stln2RgbaOptions {
...
#[wasm_bindgen]
impl Stln2RgbaOptions {
    /// Default options: straight alpha, natural size.
    #[wasm_bindgen(constructor)]
    pub fn new() -> Stln2RgbaOptions {
        Stln2RgbaOptions {
            width: 0,
            height: 0,
...
pub fn stln2rga_options_default() -> Stln2RgbaOptions {
    Stln2RgbaOptions {
        width: 0,
        height: 0,
        alpha_mode: "straight".to_string(),
...
#[wasm_bindgen]
pub fn stln2rgba(usvg: Box<[u8]>, options: Stln2RgbaOptions) -> Result<RgbaResult, JsValue> {
